...
public class ExpulsionModBlocks {
	...
	public static void load() {
		INDIGO_BRICKS = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "indigo_bricks"), new IndigoBricksBlock());
		INDIGO_BRICK_WALL = Registry.register(Registries.BLOCK,
				new Identifier(ExpulsionMod.MODID, "indigo_brick_wall"),
				new WallBlock(FabricBlockSettings.copyOf(INDIGO_BRICKS)));
		INDIGO_BRICK_SLAB = Registry.register(Registries.BLOCK,
				new Identifier(ExpulsionMod.MODID, "indigo_brick_slab"),
				new SlabBlock(FabricBlockSettings.copyOf(INDIGO_BRICKS)));
		INDIGO_BRICK_STAIRS = Registry.register(Registries.BLOCK,
		...
		BROKEN_BASALT = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "broken_basalt"), new BrokenBasaltBlock());
		INDIGO_LANTERN = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "indigo_lantern"), new IndigoLanternBlock());
		INDIGO_PILLAR = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "indigo_pillar"), new IndigoPillarBlock());
		INDIGO_PLANKS = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "indigo_planks"), new IndigoPlanksBlock());
		CHISELED_INDIGO_BRICKS = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "chiseled_indigo_bricks"), new ChiseledIndigoBricksBlock());
		CHISELED_INDIGO_PILLAR = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "chiseled_indigo_pillar"), new ChiseledIndigoPillarBlock());
		ACTIVATED_CHISELED_INDIGO_PILLAR = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "activated_chiseled_indigo_pillar"), new ActivatedChiseledIndigoPillarBlock());
		INDIGO_CHAIN = Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, "indigo_chain"), new IndigoChainBlock());
		INDIGO_PLANKS_SLAB = Registry.register(Registries.BLOCK,
				new Identifier(ExpulsionMod.MODID, "indigo_planks_slab"),
				new SlabBlock(FabricBlockSettings.copyOf(INDIGO_PLANKS)));
		INDIGO_PLANKS_STAIRS = Registry.register(Registries.BLOCK,
	...
	public static Block register (Block block, String name, boolean shouldRegister) {
		if (shouldRegister) {
			Registry.register(Registries.BLOCK, new Identifier(ExpulsionMod.MODID, name), block);
		}
		return block;
	}
}
