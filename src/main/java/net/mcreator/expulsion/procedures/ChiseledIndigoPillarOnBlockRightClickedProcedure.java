	...
	public static <Entity> void execute(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ExpulsionMod.LOGGER.warn("Failed to load dependency x for procedure ChiseledIndigoPillarOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ExpulsionMod.LOGGER.warn("Failed to load dependency y for procedure ChiseledIndigoPillarOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ExpulsionMod.LOGGER.warn("Failed to load dependency z for procedure ChiseledIndigoPillarOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				ExpulsionMod.LOGGER.warn("Failed to load dependency entity for procedure ChiseledIndigoPillarOnBlockRightClicked!");
			return;
		}
